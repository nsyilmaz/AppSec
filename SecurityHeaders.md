...
<table>
    ...
    <tbody>
        ...
        <tr>
        <td colspan=5>Ref: https://owasp.org/www-project-secure-headers/#x-frame-options <br>https://cheatsheetseries.owasp.org/cheatsheets/HTTP_Headers_Cheat_Sheet.html#security-headers</td>
        </tr>
    </tbody>
</table>
